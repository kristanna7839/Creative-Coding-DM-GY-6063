...
void setup() {
 ...
 background(0);
     ...
     line (width/2,height/2,565-sgn,657-sgn);
     di = random(2,4);
...
void draw() {
 ...
 fill(random(255),random(0,50),random(0,50), alph);
 noStroke();
 ellipse(x1,y1,di,di);
  ...
  // CREATE OTHER POINTS & CONNECTING LINE
    ...
    line (x1,y1,x2,y2); // DRAW
        ...
        stroke(random(255),0,0, random(0,150));  
        line (x2,y2, x3, y3); 
        stroke(random(255),0,0, random(0,150));  
        line (x1,y1,x3,y3);                     
