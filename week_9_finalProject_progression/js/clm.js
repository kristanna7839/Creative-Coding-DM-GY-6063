	...
	tracker : function(params) {
		...
		*/
		...
		this.draw = function(canvas, pv, path) {
			...
			var coloG = Math.floor((Math.random() * 255) + 1);
			var coloB = Math.floor((Math.random() * 255) + 1);
			
			cc.strokeStyle = "rgb("+coloR+","+coloG+","+coloB+")";
			cc.lineWidth = 2;
			...
			for (var i = 0;i < paths.length;i++) {
				...
				drawPath(cc, paths[1], params);
				drawPath(cc, paths[2], params);
			}
		}
